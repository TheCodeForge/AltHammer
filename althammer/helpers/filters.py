...
def keyword(x):
    ...
    return f'<a type="button" class="text-nowrap" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="click hover focus" data-bs-title="{kwd}" data-bs-content="{text}">{x}</a>'
