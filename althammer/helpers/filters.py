...
def keyword(x):
    ...
    return f'<span class="text-nowrap data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="click hover" data-bs-title="{kwd}" data-bs-content="{text}">{x}</span>'
